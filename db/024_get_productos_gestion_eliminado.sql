-- db/021_get_productos_gestion_eliminado.sql
...
GRANT EXECUTE ON FUNCTION hosteleria.get_productos_gestion(uuid) TO risesense_admin;
REVOKE ALL ON FUNCTION hosteleria.get_productos_gestion(uuid) FROM PUBLIC;
