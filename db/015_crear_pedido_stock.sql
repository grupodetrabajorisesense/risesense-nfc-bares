...
BEGIN
  ...
  -- Descuento atómico de stock, línea por línea. Si una línea no tiene stock
  -- suficiente, se aborta toda la transacción (ninguna línea queda descontada).
  FOR v_item IN
